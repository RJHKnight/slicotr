ab09ad <- function(dico, job, equil, ordsel, n, m, p, nr, a, b, c, tol, ldwork) {
    ...
    res <- .Fortran("AB09AD", DICO = dico, JOB = job, EQUIL = equil, ORDSEL = ordsel, N = n, M = m, P = p, NR = nr, A = a, B = b, C = c, TOL = tol, LDWORK = ldwork, HSV = hsv, IWARN = iwarn, INFO = info, LDA = lda, LDB = ldb, LDC = ldc,
