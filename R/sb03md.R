sb03md <- function(dico, job, fact, trana, n, a, u, c, ldwork) {
    ...
    res <- .Fortran("SB03MD", DICO = dico, JOB = job, FACT = fact, TRANA = trana, N = n, A = a, U = u, C = c, LDWORK = ldwork, SCALE = scale, SEP = sep, FERR = ferr, WR = wr, WI = wi, INFO = info, LDA = lda, LDU = ldu, LDC = ldc, IWORK = iwork,
        DWORK = dwork)
