...
sb10jd <- function(n, m, np, a, b, c, d, e, ldwork) {
    ...
    res <- suppressWarnings(.Fortran("SB10JD", N = n, M = m, NP = np, A = a, LDA = lda, B = b, LDB = ldb, C = c, LDC = ldc, D = d,
        LDD = ldd, E = e, LDE = lde, NSYS = nsys, DWORK = dwork, LDWORK = ldwork, INFO = info))
