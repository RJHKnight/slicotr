...
tc01od_l <- function(m, p, indlim, pcoeff, qcoeff) {
    ...
    res <- suppressWarnings(.Fortran("TC01OD", LERI = leri, M = m, P = p, INDLIM = indlim, PCOEFF = pcoeff, LDPCO1 = ldpco1, LDPCO2 = ldpco2,
        QCOEFF = qcoeff, LDQCO1 = ldqco1, LDQCO2 = ldqco2, INFO = info))
