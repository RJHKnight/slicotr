ab13bd <- function(dico, jobn, n, m, p, a, b, c, d, tol) {
    ...
    res <- .Fortran("AB13BD", DICO = dico, JOBN = jobn, N = n, M = m, P = p, A = a, B = b, C = c, D = d, TOL = tol, NQ = nq, IWARN = iwarn, INFO = info, AB13BD = ab13bd, LDA = lda, LDB = ldb, LDC = ldc, LDD = ldd, LDWORK = ldwork, DWORK = dwork)
