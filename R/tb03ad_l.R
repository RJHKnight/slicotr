tb03ad_l <- function(equil, n, m, p, a, b, c, d, tol, ldwork) {
    ...
    res <- .Fortran("TB03AD", LERI = leri, EQUIL = equil, N = n, M = m, P = p, A = a, LDA = lda, B = b, LDB = ldb, C = c, LDC = ldc, D = d, LDD = ldd, NR = nr, INDEX_BN = index_bn, PCOEFF = pcoeff,
        LDPCO1 = ldpco1, LDPCO2 = ldpco2, QCOEFF = qcoeff, LDQCO1 = ldqco1, LDQCO2 = ldqco2, VCOEFF = vcoeff, LDVCO1 = ldvco1, LDVCO2 = ldvco2, TOL = tol, IWORK = iwork, DWORK = dwork, LDWORK = ldwork,
        INFO = info)
